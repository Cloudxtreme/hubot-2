    ...
    , (error, conn) ->
        ...
        robot.respond /invite (.*)/i, (msg) ->
            ...
            token =
                ...
                date_created: date
                date_modified: date
                name: "Invitation token generated by Lavabroom"
                type: "invite"
                email: msg.match[1]

            r.table("tokens").insert(token).run conn, (error, result) ->
                if error
                    msg.reply "db error: " + error

                msg.reply "New invitation token: " + id
